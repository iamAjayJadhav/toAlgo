    ...
    <div>
      ...
      <Basement>
        <div>
          ...
          <p>
            Just like the way bubbles rise from the bottom of a glass, bubble
            sort is a <br /> simple algorithm that sorts a list, allowing either
            lower or higher values to
            <br />
            ...
            <br /> other sorting algorithms like quicksort. The upside is that
            it is one of the <br /> easiest sorting algorithms to understand and
            code from scratch.
            <br /> From technical perspective, bubble sort is reasonable for
            sorting small-sized
            <br /> arrays or specially when executing sort algorithms on
            computers with
          ...
          <p>
            Quick Sort is a sorting algorithm, which is commonly used in
            computer science.
            <br />
            Quick Sort is a divide and conquer algorithm. It creates two empty{" "}
            <br />
            arrays to hold elements less than the pivot value and elements
            greater than
